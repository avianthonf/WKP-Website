  ...
  const cmsGroups = [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'menu_counts_template', label: 'Counts template', kind: 'text', fallback: '{pizzas} pizzas, {addons} addons, {extras} extras, {desserts} desserts', description: 'Summary string shown above the menu grid.' },
        ...
        { key: 'menu_card_extra_copy', label: 'Extra copy', kind: 'textarea', fallback: 'Sized topping add-on', description: 'Fallback copy for extra cards.' },
        ...
        { key: 'menu_card_extra_kind_label', label: 'Extra kind label', kind: 'text', fallback: 'Extra', description: 'Kind label for extra cards.' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'cart_open_order_chat_label', label: 'Open order chat label', kind: 'text', fallback: 'Open order chat', description: 'Button label to open the chat on mobile.' },
        ...
        { key: 'cart_open_order_prefill_message', label: 'Open order prefill message', kind: 'textarea', fallback: 'Hi, I would like to place an order from the website.', description: 'Prefilled message used when opening the order chat before checkout.' },
